...
SOURCE_CONTRACTS: Dict[str, SourceContract] = {
    ...
    "fred": SourceContract(
        ...
        entity_contracts={
            ...
            "vix_index": SeriesContract(
                semantic_type="risk_sentiment",
                unit_kind="index_or_level",
                null_tolerance_pct=20.0,
            ...
            "fed_funds_rate": SeriesContract(
                semantic_type="policy_rate",
                unit_kind="percentage",
                null_tolerance_pct=20.0,
                outlier_z_threshold=5.0,
                enable_winsorization=True,
            ...
            "us10y_treasury_yield": SeriesContract(
                semantic_type="yield_curve",
                unit_kind="percentage",
                null_tolerance_pct=20.0,
                outlier_z_threshold=5.0,
                enable_winsorization=True,
