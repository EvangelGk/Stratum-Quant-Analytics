...
3. **Program/script**: 
   ```
   C:\Users\liagk\Project\Stratum-Quant-Analytics\run_optimizer_daily.bat
   ```
...
1. Open: `C:\Users\liagk\Project\Stratum-Quant-Analytics\output\default\.optimizer\approval_queue.json`
